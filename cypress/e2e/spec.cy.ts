 ...
 *
 * Este bloque intercepta las peticiones (no necesita backend real) y verifica que el
 * DOM refleje los datos de la respuesta asíncrona. Si la detección de cambios deja de
...
describe('Render de datos asíncronos (regresión NoopNgZone)', () => {
  beforeEach(() => {
    ...
    cy.intercept('POST', 'http://localhost:8080/api/auth', { statusCode: 401, body: {} }).as('auth');
